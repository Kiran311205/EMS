    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'Active'), ('resigned', 'Resigned'), ('on_leave', 'On Leave'), ('terminated', 'Terminated'), ('probation', 'Probation')], default='active', max_length=15)),
